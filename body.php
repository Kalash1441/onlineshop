				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								<h3>master bed<br>Collection</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							<div class="shop-img">
								<img src="./img/q03.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>chair<br>Collection</h3>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">bed</a></li>
									<li><a data-toggle="tab" href="#tab1">chair</a></li>
									<li><a data-toggle="tab" href="#tab1">tables</a></li>
									<li><a data-toggle="tab" href="#tab1">sofa</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Beds</a></li>
									<li><a data-toggle="tab" href="#tab2">sofa bed</a></li>
									<li><a data-toggle="tab" href="#tab2">couch</a></li>
									<li><a data-toggle="tab" href="#tab2">wood</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							...
							<div>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./img/product01.jepg" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
